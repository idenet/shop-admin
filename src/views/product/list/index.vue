<template>
  <page-container>
    <app-card>
      ...
      >
        <el-form-item label="商品分类">
          <el-select v-model="listParams.cate_id" placeholder="请选择" clearable @change="loadList">
    ...
    <app-card>
      <template #header>
        <el-button type="primary" :icon="Plus" @click="$router.push('/product/add_product')">添加商品</el-button>
        <el-button
      ...
      >
        ...
        <el-table-column min-width="120px" label="操作" fixed="right" align="center">
          <template #default="{ row }">
            ...
            >
              <template #reference>
                <el-button type="text">{{ row.is_del ? '恢复商品' : '移到回收站' }}</el-button>
              </template>
            </el-popconfirm>
          </template>
        </el-table-column>
